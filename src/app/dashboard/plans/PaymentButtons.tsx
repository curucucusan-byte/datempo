...
export default function PaymentButtons({ plan, price }: PaymentButtonsProps) {
  ...
  return (
    <div className="space-y-3">
      {/* Stripe/Cartão: Oculto enquanto não temos as chaves configuradas */}
      {!cardDisabled && (
        <button
          type="button"
      ...
      <button
        ...
        disabled={loading !== null}
        className="w-full rounded bg-emerald-600 py-2 px-4 text-white hover:bg-emerald-700 disabled:opacity-50"
      >
