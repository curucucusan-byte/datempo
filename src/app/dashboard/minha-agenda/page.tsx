...
import { listProfessionalsByOwner } from "@/lib/professionals";
...
export default async function MinhaAgendaPage() {
  ...
  const professionals = await listProfessionalsByOwner(user.uid);
      ...
      <header className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-4 px-6 py-8">
        <div>
          ...
          <p className="mt-2 text-slate-300">
            Ajuste as informações públicas da agenda (nome/descrição/WhatsApp) usadas no link e nos envios.
          </p>
